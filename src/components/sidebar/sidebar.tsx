  ...
  return (
    <>
      <div
        ...
        className={`fixed top-0 right-0 z-40 w-[22vw] h-full pl-8 pr-8 pt-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800 ${
      ...
      >
        ...
        <div className="py-4 overflow-y-auto flex flex-col gap-10 ">
          <CartItem />
          <CartItem />
